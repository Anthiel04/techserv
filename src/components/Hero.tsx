...
const Hero: React.FC = () => {
  return (
    <section
      id="inicio"
      className="relative h-full flex justify-center bg-gradient-to-br "
    >
      <div className="container flex justify-center px-4 md:px-6">
        <div className="flex flex-col items-center md:flex-row md:justify-between w-full">
  <div className="mb-12 text-center w-full md:w-1/2 md:mb-0 md:text-left px-4 md:px-0">
    ...
    <p className="max-w-lg mx-auto mb-8 text-lg text-gray-700 md:text-xl dark:text-gray-300 md:mx-0">
      Ofrecemos servicios especializados en tecnología para satisfacer tus necesidades.
    </p>
  ...
  <div className="hidden sm:flex justify-center w-full md:w-5/12 px-4 md:px-0">
